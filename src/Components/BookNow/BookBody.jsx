  ...
  return (
    <>
      <div className="bg-black  min-w-full min-h-full  overflow-hidden flex  flex-col  md:flex-row">
        ...
        <div className="p-10 w-full md:w-[800px] md:p-12 lg:p-24 flex flex-col gap-2 mb-0 md:mb-0 lg:mb-32">
          ...
          <div className="flex flex-col mb-60 md:mb-48 lg:mb-52  md:flex-row gap-3 md:gap-4 mt-5 md:mt-7">
