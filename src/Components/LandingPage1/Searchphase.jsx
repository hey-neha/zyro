...
const Searchphase = () => {
  return (
    <div className="w-full  relative z-10 top-[-23px] flex justify-center mt-3 md:mt-0 ">
      <div className="w-full flex flex-col justify-evenly p-4 md:p-5  md:flex-row  md:w-[700px]  bg-white shadow-2xl rounded-xl gap-4 md:gap-5">
        {/*    location */}
        <div className=" w-full md:w-1/2 gap-6 md:gap-8 p-2 md:p-3 border rounded-xl flex justify-evenly ">
        ...
        <div className=" w-full md:w-1/2 gap-6 p-2 md:p-3 border rounded-xl flex justify-evenly  bg-blue-700 text-white">
